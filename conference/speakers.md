...
* How SAST and SCA operate, and the various scanning techniques used by these tools; 
* How commercial SAST vendors fared against the OWASP benchmark, and whether the benchmark false- positive rate results were in line with the results of scanning our own apps; 
* How various commercial SCA options compare to the open-source OWASP Dependency Check tool; and 
* What value (beyond scan output) paid tools provide, compared to their open-source counterparts.
